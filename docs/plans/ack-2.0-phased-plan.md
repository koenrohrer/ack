...
- **Goal:** Adopt the `AgentProvider` vocabulary across the whole codebase (Decision 3) and remove dangling marketplace wording. Pure rename — zero behavior change.
- **Work:**
